...
MODEL_DIR_BASE = r"d:\Python-2025\Antigravity\honeywell\models\first_cut_new"
MODEL_DIR_TUNED = r"d:\Python-2025\Antigravity\honeywell\models\tuned_new"
OUTPUT_DIR_TUNED = r"d:\Python-2025\Antigravity\honeywell\outputs\tuned_new"
OUTPUT_DIR_EDA = r"d:\Python-2025\Antigravity\honeywell\outputs\eda_reports"
...
def train_and_evaluate_tuned():
    ...
    df_comp.to_csv(os.path.join(OUTPUT_DIR_EDA, "tuning_comparison_summary.csv"), index=False)
    print(f"Saved performance comparison report to outputs/eda_reports/tuning_comparison_summary.csv")
    print(df_comp)
