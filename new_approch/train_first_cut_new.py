...
MODEL_DIR = r"d:\Python-2025\Antigravity\honeywell\models\first_cut_new"
OUTPUT_DIR = r"d:\Python-2025\Antigravity\honeywell\outputs\first_cut_new"
...
def preprocess_and_feature_engineering():
    ...
    # Note: 03TI_1015.PV is excluded because it is 98.96% correlated with 03TI_1024.PV (redundant).
