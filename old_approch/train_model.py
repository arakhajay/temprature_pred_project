...
MODEL_DIR = r"d:\Python-2025\Antigravity\honeywell\models"
...
def preprocess_and_feature_engineering():
    ...
    # Highly correlated columns to create lag and rolling features
    key_cols = ['03TIC_1023.PV', '03TI_1024.PV', '03TI_1015.PV', '03PIC_1023.PV', '03TI_1081.PV']
    
    # Current values for all 19 tags
    all_tags = [col for col in df.columns if col != 'TimeStamp']
...
def train_and_evaluate():
    ...
    for h in horizons:
        ...
        # LightGBM Regressor
        # Optimize hyperparameters for time series regression
        ...
        # Note: test_data index matches the predictions. Some rows might be dropped due to NaNs.
        # We align by index.
        ...
        # Balance Precision/Recall using F1 optimization (using default 21.0 classification threshold)
